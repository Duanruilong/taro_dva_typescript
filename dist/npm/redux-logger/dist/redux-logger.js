!function (e, t) {
  ...
  function t(e, t) {
    ...
    s = s || [], p = p || [];var g = s.slice(0);if ("undefined" != typeof d) {
      ...
      if (p.filter(function (t) {
        ...
        if (p.push({ lhs: e, rhs: t }), Array.isArray(e)) {
          var w;e.length;for (w = 0; w < e.length; w++) w >= t.length ? r(new a(g, w, new i(undefined, e[w]))) : l(e[w], t[w], r, c, g, w, p);for (; w < t.length;) r(new a(g, w, new o(undefined, t[w++])));
        } else {
          var x = Object.keys(e),
    ...
    "undefined" != typeof j && k.DeepDiff === c && (k.DeepDiff = j, j = undefined);
      ...
      L = { level: "log", logger: console, logErrors: true, collapsed: undefined, predicate: undefined, duration: false, timestamp: true, stateTransformer: function (e) {
      return e;
